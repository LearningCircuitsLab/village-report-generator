---
title: "📊 COT_cannula_data 2025-09-14 Report"
date: today
format:
  html:
    theme: lux
...
max_date = pd.to_datetime("2025-09-14") + pd.Timedelta(days=1)
project = "COT_cannula_data"
subjects = ['NUO001', 'NUO002', 'NUO003', 'NUO004', 'NUO005', 'NUO006', 'NUO007', 'NUO008', 'NUO009', 'NUO010']
```
```{python}
...
Analysis of data from 2025-09-14
```{python}
