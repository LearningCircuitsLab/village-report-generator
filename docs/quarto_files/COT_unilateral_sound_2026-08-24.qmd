---
title: "📊 COT_unilateral_sound_data 2026-08-24 Report"
date: today
format:
  html:
    theme: lux
...
project = "COT_unilateral_sound_data"
subjects = ['ACV023', 'ACV024', 'ACV028', 'ACV029', 'ACV030', 'ACV031', 'ACV033']
setup_name = "village06"
```
```{python}
...
```{python}
#| label: subject_summary_for_ACV023
mouse = "ACV023"
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV024
mouse = "ACV024"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV028
mouse = "ACV028"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV029
mouse = "ACV029"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV030
mouse = "ACV030"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV031
mouse = "ACV031"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV033
mouse = "ACV033"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
