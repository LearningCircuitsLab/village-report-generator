---
title: "📊 project_two_test 2025-08-24 Report"
date: today
format:
  html:
    theme: lux
...
max_date = pd.to_datetime("2025-08-24") + pd.Timedelta(days=1)
project = "project_two_test"
subjects = ['ACV002', 'ACV003']
```
```{python}
