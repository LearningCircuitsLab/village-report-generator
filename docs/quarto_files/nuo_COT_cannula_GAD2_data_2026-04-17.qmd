---
title: "📊 COT_cannula_GAD2_data 2026-04-17 Report"
date: today
format:
  html:
    theme: lux
...
max_date = pd.to_datetime("2026-04-17") + pd.Timedelta(days=1)
project = "COT_cannula_GAD2_data"
subjects = ['NUO057', 'NUO058', 'NUO059', 'NUO060', 'NUO061', 'NUO062', 'NUO063', 'NUO064', 'NUO065']
...
```{python}
#| label: subject_summary_for_NUO057
mouse = "NUO057"
...
Analysis of data from 2026-04-17
```{python}
#| label: date_summary_for_NUO057
date = "2026-04-17"
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_NUO058
mouse = "NUO058"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_NUO059
mouse = "NUO059"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_NUO060
mouse = "NUO060"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_NUO061
mouse = "NUO061"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_NUO062
mouse = "NUO062"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_NUO063
mouse = "NUO063"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_NUO064
mouse = "NUO064"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_NUO065
mouse = "NUO065"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
