---
title: "📊 dual2AFC_iDisco_data 2026-02-27 Report"
date: today
format:
  html:
    theme: lux
...
project = "dual2AFC_iDisco_data"
subjects = ['ACV011', 'ACV012', 'ACV013', 'ACV014', 'ACV015', 'ACV016', 'ACV017', 'ACV018', 'ACV019', 'ACV020', 'ACV021', 'ACV022']
setup_name = "village01"
```
```{python}
#| label: load_events_and_sessions_summary
local_path = Path(utils.get_outpath()) / Path(project) / Path(setup_name)
events_df = utils.load_all_events(project + "/" + setup_name)
...
```{python}
#| label: subject_summary_for_ACV011
mouse = "ACV011"
...
Analysis of data from 2026-02-27
```{python}
#| label: date_summary_for_ACV011
date = "2026-02-27"
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV012
mouse = "ACV012"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV013
mouse = "ACV013"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV014
mouse = "ACV014"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV015
mouse = "ACV015"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV016
mouse = "ACV016"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV017
mouse = "ACV017"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV018
mouse = "ACV018"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV019
mouse = "ACV019"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV020
mouse = "ACV020"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV021
mouse = "ACV021"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
...
Summary of the subject's full training history
```{python}
#| label: subject_summary_for_ACV022
mouse = "ACV022"
subject_df = df[df['subject'] == mouse]
fig1 = subject_progress_figure(subject_df, perf_window=100, summary_matrix_plot=False, events_df=events_df)
plt.close('all')
